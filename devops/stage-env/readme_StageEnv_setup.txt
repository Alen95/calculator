...
Test :
	...
	2.1) You see a folder named "stage-env"
	3) Open the folder named "stage-env"
	3.1) You see a folder named "playbook", a folder named "scripts" and a file named "Vagrantfile"
********

2) Browse to the folder calculator/devops/stage-env
...
Test :
	1) Inside the terminal (and calcuator/devops/stage-env directory), run the command : vagrant ssh
	1.1) You are inside the virtual machine now
	1.2) In the terminal, you see vagrant@stage-vm-calculator as prompt
********
**** Test Case ****
Initial conditions : 
	Guideline steps 1-5 have been performed
Test :
	...
	2) Go to the following URL :
		192.168.33.17:8080/
	3) You see the apache tomcat page with the message :
...
7) Enter the requested informations :
	...
	- description : shell
	- gitlab-ci tags : stage-vm-calculator-shell
	- executor : shell
...
Test :
	...
	5) You see an active runner with the tag "stage-vm-calculator-shell"
********
...
15) Once the deployStaging stage(in the pipeline) is done, the application can be found on the following URL in your browser :
	http://192.168.33.17:8080/calculator/calculator
**** DEBUG ****
Initial conditions : 
	Guideline step 14&15 has been performed but page is not loading
Guide :
	1) Inside the terminal (and calcuator/devops/stage-env directory), run the command : vagrant reload
